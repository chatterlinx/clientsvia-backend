...
(function() {
  ...
  const CONFIG = {
    ...
    PROVENANCE_TYPES: {
      ...
      LLM_GENERATED: {
        ...
        badgeClass: 'provenance-badge-clean',
        icon: '🤖',
        description: 'Response generated by LLM agent'
      },
      HARDCODED: {
        label: 'HARDCODED',
  ...
  function renderTurnProvenance(provenance) {
    ...
    const provenanceClass = provenance.type === 'HARDCODED' ? 'hardcoded' :
                            provenance.type === 'FALLBACK' ? 'fallback' :
                            provenance.type === 'LLM_GENERATED' ? 'llm-generated' : 'ui-owned';
  ...
  function buildProvenanceSummary(turns) {
    ...
    return {
      ...
      agentTurnsTraced: realAgentTurns.filter(t => t.provenance?.type === 'UI_OWNED' || t.provenance?.type === 'LLM_GENERATED').length,
      uiOwned: turns.filter(t => (t.provenance?.type === 'UI_OWNED' || t.provenance?.type === 'LLM_GENERATED') && !isBridge(t)).length,
