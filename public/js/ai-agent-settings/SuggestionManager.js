...
class SuggestionManager {
    ...
    async getSuggestions(templateId, filters = {}, forceRefresh = false) {
        ...
        if (!forceRefresh && this.isCacheValid(templateId)) {
            logger.debug('📦 [SUGGESTION MANAGER] Cache hit', { templateId });
        ...
        try {
            ...
            logger.info('✅ [SUGGESTION MANAGER] Fetched suggestions', {
                templateId,
                count: response.count,
                filters
            });
            ...
            logger.error('❌ [SUGGESTION MANAGER] Error fetching suggestions', {
                templateId,
                error: error.message
            });
    ...
    async applySuggestion(templateId, suggestionId) {
        ...
        try {
            ...
            logger.info('✅ [SUGGESTION MANAGER] Suggestion applied', {
                templateId,
                suggestionId
            });
            ...
            logger.error('❌ [SUGGESTION MANAGER] Error applying suggestion', {
                templateId,
                suggestionId,
                error: error.message
            });
    ...
    async ignoreSuggestion(templateId, suggestionId, reason = '') {
        ...
        try {
            ...
            logger.info('✅ [SUGGESTION MANAGER] Suggestion ignored', {
                templateId,
                suggestionId,
                reason
            });
            ...
            logger.error('❌ [SUGGESTION MANAGER] Error ignoring suggestion', {
                templateId,
                suggestionId,
                error: error.message
            });
    ...
    async dismissSuggestion(templateId, suggestionId) {
        ...
        try {
            ...
            logger.info('✅ [SUGGESTION MANAGER] Suggestion dismissed', {
                templateId,
                suggestionId
            });
            ...
            logger.error('❌ [SUGGESTION MANAGER] Error dismissing suggestion', {
                templateId,
                suggestionId,
                error: error.message
            });
    ...
    async applyAllHighPriority(templateId) {
        ...
        logger.info('✅ [SUGGESTION MANAGER] Batch apply high-priority complete', {
            templateId,
            results
        });
    ...
    async ignoreAllLowPriority(templateId, reason = 'Low priority, not needed') {
        ...
        logger.info('✅ [SUGGESTION MANAGER] Batch ignore low-priority complete', {
            templateId,
            results
        });
    ...
    async applyAllByType(templateId, type) {
        ...
        logger.info('✅ [SUGGESTION MANAGER] Batch apply by type complete', {
            templateId,
            type,
            results
        });
    ...
    async analyzePatterns(templateId, testCalls) {
        ...
        try {
            ...
            logger.info('✅ [SUGGESTION MANAGER] Pattern analysis complete', {
                templateId,
            ...
            logger.error('❌ [SUGGESTION MANAGER] Error analyzing patterns', {
                templateId,
                error: error.message
            });
    ...
    startAutoRefresh(templateId, interval = null) {
        ...
        this.autoRefreshIntervalId = setInterval(async () => {
            try {
                ...
                logger.warn('⚠️ [SUGGESTION MANAGER] Auto-refresh failed', {
                    templateId,
                    error: error.message
                });
            }
        ...
        logger.info('✅ [SUGGESTION MANAGER] Auto-refresh started', {
            templateId,
    ...
    stopAutoRefresh() {
        if (this.autoRefreshIntervalId) {
            ...
            this.autoRefreshIntervalId = null;
            logger.info('✅ [SUGGESTION MANAGER] Auto-refresh stopped');
        }
    }
        ...
        if (callbacks) {
            callbacks.forEach(callback => {
                try {
                    ...
                    logger.error('❌ [SUGGESTION MANAGER] Listener error', {
                        event,
                        error: error.message
                    });
                }
