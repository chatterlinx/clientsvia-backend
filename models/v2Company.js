    ...
    /*
        ...
        knowledgeSourcePriorities: {
            ...
            priorityFlow: [{
                source: { 
                    type: String, 
                    enum: ['llm'], // V2 LEGACY REMOVED: companyQnA, tradeQnA, templates
                    required: true 
                },
            ...
            _defaultFlow: {
                ...
                default: [
                    // V2 LEGACY REMOVED: Default flow with companyQnA, tradeQnA, templates
                    // Modern LLM system uses knowledgeSettings instead
                    { source: 'llm', priority: 1, threshold: 0.5, enabled: true, fallbackBehavior: 'continue' }
                ]
            },
        ...
        // V2 LEGACY REMOVED: knowledgeManagement (companyQnA, tradeQnA, templates, inHouseFallback)
        // All knowledge now LLM-driven via knowledgeSettings
        // See knowledgeSettings schema for modern configuration
        },
