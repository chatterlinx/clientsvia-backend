...
const companySchema = new mongoose.Schema({
    ...
    companyKB: {
        type: [{
            ...
            // Auto-generated keyword fields
            keywords: { type: [String], default: [] }, // Auto-generated keywords for matching
            negativeKeywords: { type: [String], default: [] }, // Keywords to avoid false matches
            intent: { type: String, default: 'general' }, // Auto-suggested intent classification
            autoGenerated: { type: Boolean, default: true }, // Whether keywords were auto-generated
            keywordConfidence: { type: Number, default: 0.8, min: 0, max: 1 }, // Confidence in keyword generation
