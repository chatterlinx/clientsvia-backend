...
router.post('/auto-populate/:companyId', authenticateJWT, async (req, res) => {
    try {
...
router.post('/bulk-import/:companyId', authenticateJWT, async (req, res) => {
    try {
...
router.get('/analyze-gaps/:companyId', authenticateJWT, async (req, res) => {
    try {
...
router.get('/suggestions/:companyId', authenticateJWT, async (req, res) => {
    try {
        const suggestions = {
            autoGenerated: [
                {
