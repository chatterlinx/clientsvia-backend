...
router.post('/qna', async (req, res) => {
    try {
        ...
        // ============================================================================
        // 🎯 CLEAN ARCHITECTURE: Company-Specific Trade Q&A Creation
        // Purpose: Save trade-specific Q&A to CompanyQnA collection
        // Data Flow: Frontend Form → API Validation → MongoDB → Redis Cache Clear
        // ============================================================================
        
        const CompanyQnA = require('../models/knowledge/CompanyQnA');
        const mongoose = require('mongoose');
        
        // Create trade-specific Q&A entry with clean data mapping
        const tradeQnA = new CompanyQnA({
            question: question.trim(),
            answer: answer.trim(),
            category: category || 'services', // Default to 'services' for trade Q&As
            companyId: new mongoose.Types.ObjectId(companyId),
            tradeCategories: tradeCategory ? [tradeCategory] : [],
            status: 'active',
            priority: 'normal',
            keywords: req.body.keywords || [],
            autoGenerated: true // Keywords will be auto-generated by pre-save middleware
        });
        
        const savedQnA = await tradeQnA.save();
        
        // ============================================================================
        // 🚀 PERFORMANCE: Clear Redis cache for instant AI agent updates
        // ============================================================================
        ...
        // ============================================================================
        // ✅ SUCCESS RESPONSE: Clean API response for frontend
        // ============================================================================
        res.status(201).json({
            success: true,
            data: savedQnA,
        ...
        // ============================================================================
        console.error('Failed to create Trade Q&A:', error.message);
