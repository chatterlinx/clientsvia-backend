            ...
            try {
                ...
                const autoKeywords = qnas.reduce((total, qna) => {
                    if (Array.isArray(qna.autoGenerated)) {
                        ...
                        // For boolean autoGenerated, calculate: total keywords - manual keywords
                        const totalKeywords = qna.keywords.length;
                        const manualKeywords = qna.manualKeywords ? qna.manualKeywords.length : 0;
                        return total + (totalKeywords - manualKeywords);
    ...
    try {
        ...
        if (updateResult) {
            console.log('✅ EDIT Q&A: Successfully updated', {
                ...
                autoKeywords: autoKeywords.length,
