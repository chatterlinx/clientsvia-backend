 ...
 */
router.get('/trace/:callId', authenticateJWT, async (req, res) => {
    try {
 ...
 */
router.get('/trace/:callId/:turn', authenticateJWT, async (req, res) => {
    try {
 ...
 */
router.get('/traces/recent', authenticateJWT, async (req, res) => {
    try {
