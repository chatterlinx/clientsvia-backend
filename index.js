...
async function loadAllRoutes() {
    ...
    try {
        ...
        routes.globalActionHookCategoriesRoutes = await loadRouteWithTimeout('./routes/admin/globalActionHookCategories', 'globalActionHookCategoriesRoutes');
...
function registerRoutes(routes) {
    ...
    app.use('/api/admin/global-action-hook-categories', routes.globalActionHookCategoriesRoutes); // Global Action Hook Categories
