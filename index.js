...
async function loadAllRoutes() {
    ...
    try {
        ...
        routes.companyPricingRoutes       = await loadRouteWithTimeout('./routes/admin/companyPricing',       'companyPricingRoutes');       // 💰 Company Pricing (service pricing facts + 3-layer responses + advisor callback)
...
function registerRoutes(routes) {
    ...
    app.use('/api/admin/agent2/company', routes.kcIntelligenceRoutes);        // 🩺 KC Intelligence (health scan, gap mining, conflict detection, todo queue)
