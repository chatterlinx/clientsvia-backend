...
class EnterpriseVariableScanService {
    ...
    async scanCompany(companyId, options = {}) {
        ...
        try {
            ...
            // ☢️ NUKED Feb 2026: CheatSheet scanning removed - scanCheatSheetOnly() is dead
    ...
    /**
     * ☢️ NUKED Feb 2026: scanCheatSheetOnly - CheatSheet system completely removed
     * This function is a no-op tombstone.
     */
    async scanCheatSheetOnly(companyId, options = {}) {
        logger.warn(`☢️ [CHEAT SHEET SCAN] scanCheatSheetOnly called but CheatSheet is NUKED`);
        return {
            scanId: `nuked-${Date.now()}`,
            status: 'NUKED',
