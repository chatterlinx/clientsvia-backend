...
// ═══════════════════════════════════════════════════════════════════════════════
const LLM0_VERSION = '2025-12-10-V2-SMART-RECEPTIONIST';
logger.info(`[LLM0 TURN HANDLER] 🧠 LOADED VERSION: ${LLM0_VERSION}`, {
    features: [
        'Phase Sanitizer (no slot-asking in DISCOVERY)',
        'Generic Reply Killer (no chatbot speak)',
        'llmRegistry integration (brain logging)',
