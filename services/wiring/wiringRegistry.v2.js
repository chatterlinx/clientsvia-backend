                    ...
                    fields: [
                        {
                            ...
                            db: { path: 'AdminSettings.globalHub.dictionaries.firstNames' },
                        ...
                        },
                        {
                            ...
                            db: { path: 'AdminSettings.globalHub.dictionaries.lastNames' },
                    ...
                    fields: [
                        {
                            ...
                            runtime: { readers: ['StepEngine', 'BookingLogicEngine'] },
                            scope: 'company',
                            required: true,
                            critical: true,
                            tier: 'MVA',
                    ...
                    fields: [
                        {
                            ...
                            runtime: { readers: ['StepEngine', 'Agent2DiscoveryRunner'] },
                            scope: 'company',
                            required: true,
                            critical: true,
                            tier: 'MVA',
