...
const FAILURE_NODE_MAP = [
    ...
    {
        id: 'BOOKING_NO_SLOTS',
        check: (evidence) => evidence.mode === 'BOOKING' && (evidence.v110SlotCount || 0) === 0,
        severity: 'HIGH',
        nodeId: 'frontDesk.slotRegistry.slots',
        title: 'Booking Mode Active But No V110 Slots Configured',
        rule: 'AI entered BOOKING mode but no slots are configured in V110 slotRegistry.',
        fix: 'Configure slots in Front Desk → Slot Registry + Booking Flow',
        dbPath: 'aiAgentSettings.frontDeskBehavior.slotRegistry.slots',
        deepLinkSection: 'actionQueue'
    },
    {
        id: 'BOOKING_NO_STEPS',
        check: (evidence) => evidence.mode === 'BOOKING' && (evidence.v110StepCount || 0) === 0,
        severity: 'HIGH',
        nodeId: 'frontDesk.bookingFlow.steps',
        title: 'Booking Mode Active But No V110 Steps Configured',
        rule: 'AI entered BOOKING mode but no steps are configured in V110 bookingFlow.',
        fix: 'Configure steps in Front Desk → Booking Flow',
    ...
    },
    {
        ...
        severity: 'HIGH',
        nodeId: 'frontDesk.discoveryConsent.bookingRequiresExplicitConsent',
